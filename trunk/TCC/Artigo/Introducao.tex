...
Uma distribuição dinâmica de dados e tarefas em uma hierarquia de gerenciadores poderia ajudar o gerenciamento de aplicações. Um modelo denominado GRAND (\emph{Grid Robust Application Deployment}) baseado na submissão e controle particionados e hieráquicos foi proposto em \cite{Mangan2006}
...
Baseado no modelo GRAND criou-se o protótipo AppMan (\emph{Application Manager})
